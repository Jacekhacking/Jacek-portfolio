...
const entries = [
  {
    ...
    description: "Graduating December 2026. Coursework in algorithms, distributed systems, ML, systems programming, databases, parallel programming, scientific computing. Capstone: Start or Bench. A full-stack fantasy football platform with a PySpark ML pipeline.",
  ...
  },
  {
    ...
    description: "Built a Node.js/Express POS platform with an analytics dashboard and iPad integration. First production codebase and learned a lot about how hard it can be to ship production code.",
  ...
  },
  {
    ...
    subtitle:    "University of Utah",
    description: "Decided to go all in on a formal CS degree after teaching myself to code. I wanted more than what the bootcamp offered.",
    tags:        [],
    date:        "2021",
    badge:       "education",
    dot:         "filled",
